 ...
 * Theming
 ...
 --------------
  ...
  1. Memberlist
    * This page shows a list of all your members with their rank.
    * URL: members (default), can be changed in the configuration.
      Note: This page will only be available if you chose to link to a club.
  2. Memberprofiles
    * The memberprofiles will show basic data about the chosen member. In the
      configuration you can also enable to load additional details.
    * URL: members/PLAYERID (default), can be changed in the configuration.
      Note: The url is shared with the memberlist.
      Note: Memberprofiles can also be linked to linked to userprofiles on your
      site. The results will then be shown on their userprofile instead. Their
      playerprofile will redirect to their userprofile.
      Note: These pages will only be available if you chose to link to a club.
      Note: It is only possible to look up members of your club (if linked).
