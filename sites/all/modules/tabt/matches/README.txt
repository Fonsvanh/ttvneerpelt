 ...
 --------------
   1. Go to admin/config/services/tabt/matches and edit the settings:
     ...
     * Show setscores: The details of some matches include the scores for each
       ...
       Note: some settings may not be available if you chose to not link to a
       club.
   ...
   4. Go to admin/structure/blocks and choose which blocks to use.
      Note: the blocks will not work if you chose not to link to a club.
 PAGES
 --------------
   The following pages are available in this module:

   1. Calendars
     * A calendarpage for each team will be available with links to the
       matchresults if available.
     * URL: championship/calendar/TEAM (default), can be changed in the
       configuration.
       Note: This page will only be available if you chose to link to a club.
   2. Rankings (teams)
     * For each team a page showing their ranking in their division will be
       available.
	 * URL: championship/ranking/TEAM (default), can be changed in the
	   configuration.
	   Note: This page will only be available if you chose to link to a club.
   3. Rankings (division)
     * For each division a page showing their ranking in their division will be
       available.
     * URL: championship/ranking/DIVISIONID (default), can be changed in the
       configuration.
       Note: This page will only be available if you chose not to link to a
       club.
   4. Matchpage
     * A page showing the detailed results of a match will be available.
       Playernames will be linked to their profile on the TabT-website.
     * URL: championship/match/MATCHID (default), can be changed in the
       configuration.
       Note: If you enable the members module, members will be linked to their
       playerprofiles on your site instead.
       Note: This page will only be available if you chose to link to a club.
